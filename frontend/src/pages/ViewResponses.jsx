...
const ViewResponses = () => {
    ...
    return (
        <>
            <div className="max-w-7xl mx-auto space-y-10 animate-fade-in py-6 px-[10px] sm:px-6 lg:px-8">
                ...
                <div className="bg-white/95 backdrop-blur-xl rounded-[2.5rem] shadow-2xl border border-white/20 relative">
                    ...
                    {loading ? (
                        ...
                        <div className="max-h-[650px] overflow-auto custom-scrollbar border-t border-gray-100 rounded-b-[2.5rem]">
                            <table className="min-w-full border-separate border-spacing-0">
                                <thead className="sticky top-0 z-30">
                                    <tr className="bg-gray-100 shadow-sm">
                                        <th className="px-8 py-6 text-left text-xs font-black text-gray-400 uppercase tracking-[0.2em] bg-gray-100 sticky top-0">S/N</th>
                                        <th className="px-8 py-6 text-left text-xs font-black text-gray-400 uppercase tracking-[0.2em] bg-gray-100 sticky top-0">Store</th>
                                        <th className="px-8 py-6 text-left text-xs font-black text-gray-400 uppercase tracking-[0.2em] bg-gray-100 sticky top-0">Employee</th>
                                        <th className="px-8 py-6 text-left text-xs font-black text-gray-400 uppercase tracking-[0.2em] bg-gray-100 sticky top-0">Product</th>
                                        <th className="px-8 py-6 text-left text-xs font-black text-gray-400 uppercase tracking-[0.2em] bg-gray-100 sticky top-0">Serial Number</th>
                                        <th className="px-8 py-6 text-left text-xs font-black text-gray-400 uppercase tracking-[0.2em] bg-gray-100 sticky top-0">Contact Email</th>
                                        <th className="px-8 py-6 text-left text-xs font-black text-gray-400 uppercase tracking-[0.2em] bg-gray-100 sticky top-0">Sight App Email</th>
                                        <th className="px-8 py-6 text-left text-xs font-black text-gray-400 uppercase tracking-[0.2em] bg-gray-100 sticky top-0">FOB</th>
                                        <th className="px-8 py-6 text-left text-xs font-black text-gray-400 uppercase tracking-[0.2em] bg-gray-100 sticky top-0">Rebate</th>
                                        <th className="px-8 py-6 text-left text-xs font-black text-gray-400 uppercase tracking-[0.2em] bg-gray-100 sticky top-0">Status</th>
                                        <th className="px-8 py-6 text-left text-xs font-black text-gray-400 uppercase tracking-[0.2em] bg-gray-100 sticky top-0">Created</th>
                                        <th className="px-8 py-6 text-center text-xs font-black text-gray-400 uppercase tracking-[0.2em] bg-gray-100 sticky top-0">Actions</th>
                                    </tr>
                                </thead>
                                        ...
                                        requests.map((request, index) => (
                                            <tr 
                                                ...
                                                className={`transition-colors duration-200 group ${
                                                    ...
                                                    ? 'bg-green-100 hover:bg-green-200/50' 
                                                    : 'hover:bg-red-50/30'
                                                }`}
                                            >
            ...
            {isViewModalOpen && selectedRequest && createPortal(
                <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-sm animate-fade-in">
            ...
            {isDeleteModalOpen && createPortal(
                <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-sm animate-fade-in">
